...
TRANSACTION_PIN_MAX_ATTEMPTS = int(os.getenv('TRANSACTION_PIN_MAX_ATTEMPTS', '5'))
TRANSACTION_PIN_LOCKOUT_MINUTES = int(os.getenv('TRANSACTION_PIN_LOCKOUT_MINUTES', '15'))
